import { composeUpdate, composeWelcome, MessageFromClient, MessagePayloadFromClient, UpdateRequestMessage } from "../common/Message.ts";
...
const handleUpdateRequest = (_client: WebSocket, payload: UpdateRequestMessage["payload"]) => {
